...
const MyPostWidget = ({ picturePath }) => {
    ...
    const handlePost = async () => {
        try {
            ...
            const { data } = await APISUBMIT.post('posts', formData);
            if (data) {
    ...
    return (
        <WidgetWrapper>
            ...
            <FlexBetween>
                ...
                <Button onClick={handlePost} sx={{ backgroundColor: palette.background.alt, "&:hover": { cursor: "pointer", color: palette.primary.main } }} endIcon={<PublicIcon />} variant="outlined" >Post</Button>
            </FlexBetween>
        </WidgetWrapper>
    );
};
